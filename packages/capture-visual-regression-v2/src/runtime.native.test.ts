...
nativeProof("stable scene identity with real browser navigation", () => {
  it("captures identical bytes through different ephemeral ports without changing scene identity", async () => {
    const scene = createScene({ id: "project-home", url: "https://reference-alfil.nexus.invalid/" });
