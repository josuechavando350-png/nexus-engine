...
export function evaluateCwvLifecycle(
  ...
  if (!sampleInput || typeof sampleInput !== "object" || Array.isArray(sampleInput) || Object.keys(sampleInput).sort().join(",") !== "cls,inpMs,lcpMs,recentLongTaskMs,visibility") {
  ...
  if (sample.visibility === "HIDDEN") {
    return Object.freeze({ state: "PAUSED", reasons: Object.freeze(["HIDDEN"] as const), shouldSuspendSpeculation: true });
  }
