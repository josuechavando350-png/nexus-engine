...
python3 -m py_compile runtime/__init__.py runtime/catalog.py runtime/seo_avengers_1200.py runtime/batch_201_502.py runtime/batch_203_504.py runtime/batch_205_506.py runtime/batch_207_508.py runtime/batch_209_214.py runtime/batch_309_314.py runtime/batch_313_314.py runtime/batch_315_320.py runtime/batch_601_802.py runtime/batch_603_1004.py runtime/batch_605_1006.py runtime/wire.py runtime/legacy_bridge.py runtime/service.py tests/test_runtime.py tests/test_batch_201_502.py tests/test_batch_203_504.py tests/test_batch_205_506.py tests/test_batch_207_508.py tests/test_batch_209_214.py tests/test_batch_309_314.py tests/test_batch_315_320.py tests/test_batch_601_802.py tests/test_batch_603_1004.py tests/test_batch_605_1006.py tests/test_gateway_edges.py tests/test_outbox_worker.py tests/test_legacy_bridge.py scripts/run.py scripts/process-outbox.py
...
assert len(PRE_GATE_MODULES) == 71
assert all(not row["executable_here"] for row in registry.values() if row["status"] == "RESERVED")
assert sum(1 for row in registry.values() if row["status"] == "IMPLEMENTED_PRODUCTION") == 73
assert registry["M316"]["status"] == "RESERVED"
assert registry["M316"]["executable_here"] is False
print("1200 contiguous slots; exactly 73 reviewed extended handlers; M316+ reserved slots remain non-executable")
PY
...
try {
  ...
  for (const key of ["search_performance_records", "keyword_coverage_records", "traffic_window_records", "traffic_series_records", "revenue_funnel_records", "revenue_attribution_records", "content_documents", "content_decay_records", "external_pages", "local_business_records", "site_images_data"]) {
