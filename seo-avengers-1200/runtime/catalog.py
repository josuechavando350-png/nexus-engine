...
from .mass_lot_runtime_manifest import RUNTIME_MASS_LOT_TARGET_MODULES
...
IMPLEMENTED_EXTENDED_MODULES = BASE_IMPLEMENTED_EXTENDED_MODULES | RUNTIME_MASS_LOT_TARGET_MODULES
