...
import { canonicalizeDeterministicBuildFile, describeDeterminismDifferences } from "./deterministic-build-canonicalization.mjs";
...
const differenceReport = describeDeterminismDifferences(workspaceDiff);
