...
async function main() {
  ...
  process.stdout.write(`${JSON.stringify({ authority: result.authority, status: result.status, stageLog: result.stageLog, certification: result.certification, blocker: result.blocker, error: result.error }, null, 2)}\n`);
