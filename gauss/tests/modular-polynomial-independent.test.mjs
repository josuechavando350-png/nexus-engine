...
import {fpPowerMod, fpInverseMod, fpProduct, fpDivision, fpDiscriminant} from '../core/layers/batch-800-finite-polynomials.mjs';
...
function add(a,b,p){return trim(Array.from({length:Math.max(a.length,b.length)},(_,i)=>mod((a[i]??0)+(b[i]??0),p)));}
