...
const banks=[runSequence438Bank,runIntegerPolynomial438Bank,runIntegerMatrix438Bank,runGraphInvariant438Bank,runUnicode438Bank,runFiniteNumber438Bank];
...
test('AXIOMA new banks detect falsified output and permissive invalid-input handling',()=>{
 for(const [bank,id] of [[runSequence438Bank,'GAUSS.STATS.SEQ_SUBSET_SUM_COUNT.301'],[runIntegerPolynomial438Bank,'GAUSS.MATH.EXACT_POLY_ADD.301'],[runIntegerMatrix438Bank,'GAUSS.MATH.EXACT_MATRIX_ADD.326'],[runGraphInvariant438Bank,'GAUSS.CS.GRAPH_DEGREE_SEQUENCE.301'],[runUnicode438Bank,'GAUSS.CS.PREFIX_FUNCTION.201'],[runFiniteNumber438Bank,'GAUSS.MATH.MERTENS.223']]){
