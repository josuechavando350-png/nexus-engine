...
export async function buildGaussFoundationFixture() {
  ...
  if (!Array.isArray(baseline.tasks) || baseline.tasks.length !== 200
      || !Array.isArray(extension.tasks) || extension.tasks.length !== 3
  ...
  return { ...baseline,
    objective: 'Exercise all 203 implemented GAUSS scientific operators with deterministic evidence and independently verified replay.',
    tasks };
}
