...
class Batch10011200Tests(unittest.TestCase):
    ...
    def test_registry_marks_only_reviewed_range_executable(self):
        ...
        for i in range(1001,1601): self.assertEqual(registry[f"M{i}"]["status"],"IMPLEMENTED_PRODUCTION")
        for i in range(1601,2501): self.assertEqual(registry[f"M{i}"]["status"],"RESERVED_NOT_EXECUTABLE")
