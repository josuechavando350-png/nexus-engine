...
node --check "$SUITE/classical-baseline/baseline-solver.mjs"
...
node --check "$SUITE/quantum-runtime/providers/ibm/ibm-repeated-series-gate.mjs"
node --check "$SUITE/quantum-runtime/providers/ibm/ibm-physical-session-coordinator.mjs"
...
grep -Fx 'qiskit-ibm-runtime==0.49.0' "$SUITE/quantum-runtime/providers/ibm/requirements.txt" >/dev/null
grep -Fx 'qiskit-qasm3-import==0.6.0' "$SUITE/quantum-runtime/providers/ibm/requirements.txt" >/dev/null
