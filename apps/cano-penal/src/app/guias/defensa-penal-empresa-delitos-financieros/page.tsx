...
export default function BusinessPage(){
  return <PageShell>
    ...
    <section className="cp-biz-scope"><div className="cp-wrap"><p className="cp-eyebrow">Áreas relacionadas</p><h2>El mismo rigor.<br/><em>Distintos escenarios.</em></h2><div className="cp-biz-row-list">{scopes.map(([title,copy])=><article key={title}><h3>{title}</h3><p>{copy}</p><span aria-hidden="true">↗</span></article>)}</div></div></section>
