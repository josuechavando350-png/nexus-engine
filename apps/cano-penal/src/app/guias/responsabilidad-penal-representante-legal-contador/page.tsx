...
export default function ProfessionalsPage(){
  return <PageShell>
    <section className="cp-pro-hero"><div className="cp-wrap cp-pro-hero-grid"><div><p className="cp-eyebrow">Penal fiscal · Profesionales</p><h1>Una firma.<br/>Una decisión.<br/><em>Un contexto.</em></h1></div><div><span>PERFIL PROFESIONAL</span><p>Cuando una empresa enfrenta preguntas de la autoridad, el rol de cada persona importa. No conviene tratar todas las responsabilidades como si fueran iguales.</p><Link href="/areas/delitos-fiscales-y-financieros">Ir al área fiscal ↗</Link></div></div></section>
    <section className="cp-pro-split"><div className="cp-pro-panel cp-pro-panel-a"><span>REPRESENTANTES</span><h2>Representante<br/><em>legal.</em></h2><p>La representación de una empresa puede exigir revisar decisiones, facultades, documentación y actuaciones concretas. La situación penal debe evaluarse conforme a los hechos y no sólo al cargo.</p><a href={site.whatsapp} rel="noopener noreferrer" target="_blank">Revisar mi situación ↗</a></div><div className="cp-pro-panel cp-pro-panel-b"><span>CONTABILIDAD</span><h2>Contador<br/><em>o asesor.</em></h2><p>El alcance de una asesoría, las operaciones documentadas y el contexto de una investigación requieren un análisis específico. No debe presumirse responsabilidad por una función profesional.</p><a href={site.whatsapp} rel="noopener noreferrer" target="_blank">Consultar con CANO ↗</a></div></section>
