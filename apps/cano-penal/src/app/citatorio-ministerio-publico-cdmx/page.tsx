...
const fields=[
  ["Autoridad","Quién emite la comunicación y cómo aparece identificada."],
  ["Comparecencia","Qué fecha, lugar y finalidad señala el documento."],
  ["Situación","Qué información necesitas aclarar con tu abogado antes de actuar."],
] as const;
