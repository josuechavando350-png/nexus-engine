...
export default function HomePage() {
  return (
    <PageShell>
      ...
      <section className="cp-section"><div className="cp-wrap"><div className="cp-section-head"><h2>En sala, en cada audiencia.</h2></div><div className="cp-audiences">{audienceFiles.map(file => <img src={`/media/${file}`} alt="" key={file} />)}</div></div></section>
