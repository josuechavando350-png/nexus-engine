...
export default function AudienciaPage(){
  return <PageShell>
    ...
    <section className="cp-aud-editorial"><div className="cp-wrap"><div className="cp-aud-intro"><span>03 / EJES DE PREPARACIÓN</span><h2>Un análisis con<br/>dirección.</h2></div><div className="cp-aud-focus">{focus.map(([title,copy],i)=><article key={title}><b>0{i+1}</b><h3>{title}</h3><p>{copy}</p></article>)}</div></div></section>
