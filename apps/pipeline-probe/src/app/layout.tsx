...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="es-MX"><body><a className="nexus-skip-link" href="#main-content">Saltar al contenido</a><Cortex08PrerenderClient /><Cortex09FrictionClient />{children}</body></html>;
}
