...
function ProductSigil({ kind }: { kind: (typeof products)[number][0] }) {
  if (kind === "AI") return <svg className="product-sigil" viewBox="0 0 120 120" aria-hidden="true"><path d="M60 18v84M60 52 43 69M60 66l18-14M60 83 48 94"/><circle cx="60" cy="18" r="2.5"/><circle cx="60" cy="52" r="2.5"/><circle cx="43" cy="69" r="2.5"/><circle cx="78" cy="52" r="2.5"/><circle cx="48" cy="94" r="2.5"/><circle cx="60" cy="102" r="2.5"/></svg>;
  if (kind === "WEB") return <svg className="product-sigil" viewBox="0 0 120 120" aria-hidden="true"><path d="M76 31c-21-10-47 5-48 29-2 25 24 41 45 29 19-11 20-38 3-50-17-12-41-3-44 18-3 21 18 37 37 29 15-6 23-23 17-38"/><circle cx="76" cy="31" r="2.5"/><circle cx="28" cy="60" r="2.5"/><circle cx="86" cy="48" r="2.5"/></svg>;
  if (kind === "SEARCH") return <svg className="product-sigil" viewBox="0 0 120 120" aria-hidden="true"><path d="M60 22v76M22 60h76"/><circle cx="60" cy="22" r="2.5"/><circle cx="98" cy="60" r="2.5"/><circle cx="60" cy="98" r="2.5"/><circle cx="22" cy="60" r="2.5"/><circle cx="60" cy="60" r="3"/></svg>;
  return <svg className="product-sigil" viewBox="0 0 120 120" aria-hidden="true"><ellipse cx="60" cy="60" rx="45" ry="20" transform="rotate(-31 60 60)"/><circle cx="22" cy="84" r="3"/><circle cx="98" cy="36" r="3"/></svg>;
}

export default function HomePage() {
  return <main id="main-content">
    <section className="hero" aria-labelledby="hero-title">
      <Image src="/hero-reference.jpg" alt="Interior arquitectónico nocturno con vista a la ciudad" fill priority unoptimized sizes="100vw" />
